...
const JelajahiEvent: React.FC<JelajahiEventProps> = ({ onEventSelect }) => {
  ...
  const allEvents = [
    ...
    },
    {
      ...
      organizer: 'Jakarta Music Events',
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="border-t pt-3">
          ...
          <p className="text-xl font-bold text-gray-800">{event.price}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-gray-600 mb-6">Temukan event menarik yang kamu suka!</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {visibleEvents.map((event) => (
            <Pcard key={event.id} event={event} />
          ))}
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Bergabunglah dengan kami untuk pengalaman tak terlupakan! Event ini menghadirkan 
                hiburan kelas dunia dengan fasilitas lengkap dan kenyamanan maksimal untuk semua pengunjung.
              </p>
            </div>
          </div>
            ...
            <div className="sticky top-8 space-y-6">
              <div className="bg-white rounded-2xl shadow-md p-6">
                ...
                <div className="space-y-4">
                  {packages.map((pkg) => (
                    <div key={pkg.id} className="border-2 border-gray-200 rounded-xl p-4 hover:border-yellow-400 transition-all">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-2xl shadow-md p-6">
              <div className="flex gap-4">
                <img src={orderData.event.image} alt={orderData.event.title} className="w-32 h-24 rounded-xl object-cover" />
                <div>
  ...
  return (
    <div>
      {currentPage === 'jelajahi' && (
        <JelajahiEvent onEventSelect={handleEventSelect} />
      )}
